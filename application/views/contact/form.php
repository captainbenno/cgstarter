...
<!-- beginning of pledge row -->
    ...
    <div class="container-fluid checkout">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1>Contact Us</h1>
                <p>Got something to tell us? We are genuinely interested in what you have to say and we respond within 24 hours, so please go ahead, fill in the form below and send us your thoughts.</p>
                <?php echo form_open('', array('role'=>'form')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6<?php echo form_error('title') ? ' has-error' : ''; ?>">
                            <?php echo form_label('Subject', 'title', array('class'=>'control-label')); ?>
                            <span class="required">*</span>
