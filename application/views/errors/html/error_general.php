...
<head>
	...
	<title>CGStarter.com - DB gone bye bye</title>
	...
	<link rel="stylesheet" href="/themes/core/css/core.css?v=3.2.4">
	<link rel="stylesheet" href="/themes/default/css/default.css?v=3.2.4">
	<link rel="stylesheet" href="https://cgstarter.com/themes/default/css/default.css?v=3.2.4">
	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li>
					<a href="https://cgstarter.com/admin">Admin</a>
				</li>
				<li>
					<a href="/logout">Logout</a>
				</li>
				<li class=""><a href="https://cgstarter.com/profile">Profile</a></li>

			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li class="">
					<a class="mini-cart" role="buton" href="https://cgstarter.com/cart">
	...
	<div class="container-fluid">
		<div id="navbar-main">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class=""><a href="/project/expose12">Projects</a></li>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8" style="padding:40px;text-align: center">
			<h1 style="font-size: 200px">????</h1>
			<p class="lead">
				Strange things are afoot, chill for a bit n come on back l8r.
			</p>
