...
<?php
        ...
        $settings[0]['label'] = "News Title";
        $settings[0]['value'] = $news['title'];
        ...
        $settings[1]['value'] = $news['description'];
?>

<?php echo form_open('', array('role'=>'form')); ?>
<input type="hidden" name="project_news_id" value="<?php echo $news['project_news_id'] ?>" />
